...
int simdflate_cpu_support() {
	...
	CPUIDX(flags, 7, 0);
	if((flags[1] & 0xD0210108) == 0xD0210108 // AVX512BW + AVX512VL + AVX512CD + AVX512IFMA + AVX512F + BMI2 + BMI1
	&& (flags[2] & 0x5D42) == 0x5D42) // AVX512VPOPCNTDQ + AVX512BITALG + AVX512VNNI + VPCLMULQDQ + GFNI + AVX512VBMI2 + AVX512VBMI
